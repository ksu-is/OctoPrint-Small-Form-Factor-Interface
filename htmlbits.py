class Buttons:
    ...
    def bed_clear():
        return '<label class="switch"><input type="checkbox"><span class="slider round"></span></label><hr>'
    
class Views:    
    def status_display_upper_title_emphasis(printer_status):
        return f'<h2 class="display-1" style="font-weight:bold; font-size: 6rem;">{printer_status}</h2>'

    def status_display_upper_title(printer_status):
